    ...
    <div className="min-h-screen bg-gray-100 text-green-900">
      ...
      <header className="text-center py-16 bg-yellow-50">
        ...
        <p className="mt-4 text-lg">
          Start your meal with these delicious beverages.
        </p>
      </header>

      {/* Featured Beverages Recipes */}
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            "Carob Juice عصير خرنوب",
            "Lemonade with Mint ليمون بالنعناع",
            "Date Milkshake ميلك شيك التمر",
          ].map((appetizer) => (
            <div
              key={appetizer}
